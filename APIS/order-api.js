...
orderApiObject.post('/createorder', validateToken, errorHandler(async (req, res) => {
...
orderApiObject.get('/getorders/:userName', validateToken, errorHandler(async (req, res) => {
